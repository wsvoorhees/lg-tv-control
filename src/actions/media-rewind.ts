...
@action({ UUID: "com.will-voorhees.smart-tv-control.media-rewind" })
export class MediaRewind extends SingletonAction<BaseTvActionSettings> {
    override async onKeyDown(ev: KeyDownEvent<BaseTvActionSettings>): Promise<void> {
        ...
        try {
            ...
            await client.request("ssap://media.controls/rewind");
        } catch { /* ignore */ }
    }
}
